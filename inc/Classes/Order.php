...
class Order implements JsonSerializable {
    ...
    /**
     * Set the value of items_total
     *
     * @return  self
     */ 
    public function setItems_total($items_total)
    {
    ...
    public function jsonSerialize(){   
        ...
        $newOrder->id = $this->id;
        $newOrder->items_total = $this->items_total;
        $newOrder->payment_method = $this->payment_method;
        $newOrder->payment_status = $this->payment_status;
