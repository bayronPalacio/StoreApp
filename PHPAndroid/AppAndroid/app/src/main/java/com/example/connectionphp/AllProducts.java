package com.example.connectionphp;
...
//    private static String url_all_products = "https://api.androidhive.info/android_connect/get_all_products.php";
    private static String url_all_products = "https://myprojectstore.000webhostapp.com/";
...
//            Toast.makeText(getBaseContext(), "here in all products", Toast.LENGTH_SHORT).show();
